...
const NexusAuthService = {
    ...
    ROLE_CONFIG: {
        ...
        // Escala oficial: DIRETOR > SUPERINTENDENTE > GERENTE > COORDENADOR
        // > CONSULTOR > ANALISTA > MONITOR. Coordenador estava abaixo de
        // consultor aqui e nas regras — invertido. Ver cargoLevel() em
        // firestore.rules, que é a fonte da verdade.
        'COORDENADOR': { level: 3, label: 'COORDENADOR', canManageUsers: false },
        'CONSULTOR': { level: 2, label: 'CONSULTOR', canManageUsers: false },
