...
const ToolsService = {
  ...
  TOOLS_CONFIG: {
    ...
    gut: { name: 'Matriz GUT', icon: 'fa-ranking-star', category: 'Qualidade', color: '#a855f7' },
    ...
    cartacontrole: { name: 'Carta de Controle', icon: 'fa-chart-line', category: 'CEP', color: '#6366f1' },
    correlacao: { name: 'NEP Correlação', icon: 'fa-chart-line', category: 'Estatística', color: '#8b5cf6' },
    ...
    weather: { name: 'NEP Clima', icon: 'fa-cloud-sun', category: 'API', color: '#3b82f6' },
